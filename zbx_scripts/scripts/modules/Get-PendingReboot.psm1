...
function Get-PendingReboot {
    ...
    foreach ($pendingFileRenameOperation in $pendingFileRenameOperations) {
        if ($pendingFileRenameOperation.Contains('\Windows\system32\spool') -or $pendingFileRenameOperation.Contains('\Google\Chrome\Temp') -or $pendingFileRenameOperation.Contains('\Google\Update')) {
